# Generated by Django 3.2 on 2024-12-04 20:40
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('username', models.CharField(max_length=150, unique=True, validators=[django.contrib.auth.validators.UnicodeUsernameValidator(), django.core.validators.RegexValidator(flags=re.RegexFlag['IGNORECASE'], inverse_match=True, message='Недопустимое имя пользователя.', regex='\\bme\\b')], verbose_name='Имя пользователя')),
                ...
                ('confirmation_code', models.CharField(blank=True, max_length=10, validators=[django.core.validators.RegexValidator(message='Некорректный код подтверждения.', regex='^[A-Z\\d]{10}$')], verbose_name='Код подтверждения')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('year', models.PositiveSmallIntegerField(validators=[reviews.validators.validate_year], verbose_name='Год производства')),
